...
public class SimlifeProperties {
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private boolean enabled = SimlifeDefaults.Metrics.Graphite.enabled;

            private String host = SimlifeDefaults.Metrics.Graphite.host;

            private int port = SimlifeDefaults.Metrics.Graphite.port;

            private String prefix = SimlifeDefaults.Metrics.Graphite.prefix;
        ...
        public static class Prometheus {
            ...
            private boolean enabled = SimlifeDefaults.Metrics.Prometheus.enabled;

            private String endpoint = SimlifeDefaults.Metrics.Prometheus.endpoint;
    ...
    public static class Logging {
        ...
        public static class SpectatorMetrics {
            ...
            private boolean enabled = SimlifeDefaults.Logging.SpectatorMetrics.enabled;
    ...
    public static class Ribbon {
        ...
        private String[] displayOnActiveProfiles = SimlifeDefaults.Ribbon.displayOnActiveProfiles;
