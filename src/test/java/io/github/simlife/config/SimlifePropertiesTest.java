...
public class SimlifePropertiesTest {
    ...
    public void testMetricsGraphiteEnabled() {
        SimlifeProperties.Metrics.Graphite obj = properties.getMetrics().getGraphite();
        boolean val = SimlifeDefaults.Metrics.Graphite.enabled;
        assertThat(obj.isEnabled()).isEqualTo(val);
        val = !val;
        obj.setEnabled(val);
        assertThat(obj.isEnabled()).isEqualTo(val);
    ...
    public void testMetricsGraphiteHost() {
        SimlifeProperties.Metrics.Graphite obj = properties.getMetrics().getGraphite();
        String val = SimlifeDefaults.Metrics.Graphite.host;
        assertThat(obj.getHost()).isEqualTo(val);
        val = "1" + val;
        obj.setHost(val);
        assertThat(obj.getHost()).isEqualTo(val);
    ...
    public void testMetricsGraphitePort() {
        SimlifeProperties.Metrics.Graphite obj = properties.getMetrics().getGraphite();
        int val = SimlifeDefaults.Metrics.Graphite.port;
    ...
    public void testMetricsGraphitePrefix() {
        SimlifeProperties.Metrics.Graphite obj = properties.getMetrics().getGraphite();
        String val = SimlifeDefaults.Metrics.Graphite.prefix;
    ...
    public void testMetricsPrometheusEnabled() {
        SimlifeProperties.Metrics.Prometheus obj = properties.getMetrics().getPrometheus();
        boolean val = SimlifeDefaults.Metrics.Prometheus.enabled;
        assertThat(obj.isEnabled()).isEqualTo(val);
        val = !val;
        obj.setEnabled(val);
        assertThat(obj.isEnabled()).isEqualTo(val);
    ...
    public void testMetricsPrometheusEndpoint() {
        SimlifeProperties.Metrics.Prometheus obj = properties.getMetrics().getPrometheus();
        String val = SimlifeDefaults.Metrics.Prometheus.endpoint;
    ...
    public void testLoggingSpectatorMetricsEnabled() {
        SimlifeProperties.Logging.SpectatorMetrics obj = properties.getLogging().getSpectatorMetrics();
        boolean val = SimlifeDefaults.Logging.SpectatorMetrics.enabled;
        assertThat(obj.isEnabled()).isEqualTo(val);
        val = !val;
        obj.setEnabled(val);
        assertThat(obj.isEnabled()).isEqualTo(val);
    ...
    public void testRibbonDisplayOnActiveProfiles() {
        SimlifeProperties.Ribbon obj = properties.getRibbon();
        String[] def = SimlifeDefaults.Ribbon.displayOnActiveProfiles;
        ArrayList<String> val;
        if (def != null) {
            val = newArrayList(def);
