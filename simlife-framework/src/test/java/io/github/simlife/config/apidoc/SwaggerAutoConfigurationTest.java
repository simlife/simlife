...
import io.github.simlife.config.SimlifeProperties.Swagger;
import io.github.simlife.config.apidoc.customizer.SimlifeSwaggerCustomizer;
import io.github.simlife.config.apidoc.customizer.SwaggerCustomizer;
...
public class SwaggerAutoConfigurationTest {
    ...
    public void testSwaggerSpringfoxApiDocket() {
        List<SwaggerCustomizer> customizers = Lists.newArrayList(new SimlifeSwaggerCustomizer(properties));
