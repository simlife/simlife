...
package io.github.simlife.config.apidoc.customizer;
...
/**
 * A swagger customizer to setup {@link Docket} with Simlife settings.
 */
public class SimlifeSwaggerCustomizer implements SwaggerCustomizer, Ordered {
    ...
    public SimlifeSwaggerCustomizer(SimlifeProperties.Swagger properties) {
